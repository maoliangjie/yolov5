...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        weights = 'C:/Users/Administrator/Desktop/Git/yolov5-5.0/runs/train/visdrone/weights/best.pt'# 模型加载路径
        imgsz = 640  # 预测图尺寸大小
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "YOLO目标检测展示"))
